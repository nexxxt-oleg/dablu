    ...
    if (window.innerWidth > 1199) {
       var rellax = new Rellax('.rellax');
        ...
        if (ScrollTrigger.isTouch !== 1) {
            gsap.fromTo('.company-header', { opacity: 1 }, {
                opacity: 0.1,
                scrollTrigger: {
            ...
            gsap.fromTo('.company-sectr2', { opacity: 0, }, {
                opacity: 1,
                scrollTrigger: {
                    trigger: '.company-sectr2',
                    start: '-800',
                    end: '-550',
                    scrub: true
                }
            ...
            Array.from(document.querySelectorAll('.fade-img')).forEach((el) => {
                gsap.from(el, {
                    scrollTrigger: {
                        trigger: el,
                        ease: "power3.InOut",
